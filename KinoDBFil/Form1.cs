...
namespace KinoDBFil
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection connection = new SqlConnection(@"Data Source = (LocalDB)\MSSQLLocalDB; AttachDbFilename =|DataDirectory|\AppData\kinodbfil.mdf; Integrated Security = True");
        int[] row_list;
        int[] places_list;
        public Form1()
        {
            ...
            Text = "Hall selection";
            connection.Open();
            Hall_adapter = new SqlDataAdapter("SELECT * FROM Hall", connection);
